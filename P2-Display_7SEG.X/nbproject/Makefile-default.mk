...
SOURCEFILES_QUOTED_IF_SPACED=display7seg.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/display7seg.o
POSSIBLE_DEPFILES=${OBJECTDIR}/display7seg.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/display7seg.o

# Source Files
SOURCEFILES=display7seg.s
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/display7seg.o: display7seg.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/display7seg.o 
	${MP_AS} -mcpu=PIC18F57Q84 -c \
	-o ${OBJECTDIR}/display7seg.o \
	display7seg.s \
